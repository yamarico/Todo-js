...
var createIncompleteList = function createIncompleteList(text) {
  ...
  completeButton.addEventListener("click", function () {
    ...
    deleteFromIncompleteList(deleteButton.parentNode); //完了リストに追加する.

    var addTarget = completeButton.parentNode;
    var text = addTarget.firstElementChild.innerText; //ToDo内容Textを取得

    console.log(text); //div以下を初期化

    addTarget.textContent = null;
    console.log(addTarget); // liタグを作成

    var li = document.createElement("li");
    li.innerText = text; // buttonタグを作成
